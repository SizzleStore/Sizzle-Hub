...
Este código cria uma interface de usuário (UI) no Roblox usando a biblioteca Fluent. Abaixo, um tutorial para entender cada parte:
...
Esses três comandos carregam a biblioteca principal e dois gerenciadores (salvar configurações e gerenciar interface).


2. Criar a Janela Principal:

local Window = Fluent:CreateWindow({
    Title = "Sizzle Hub " .. Fluent.Version,
    TabWidth = 160, Size = UDim2.fromOffset(580, 460), Theme = "Dark"
})

Esta parte cria a janela principal da interface com tema escuro e define o tamanho e título.
...
O SaveManager e InterfaceManager são integrados à janela Fluent para gerenciar configurações e interfaces.
